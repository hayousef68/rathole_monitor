...
```bash
wget -O install.sh https://raw.githubusercontent.com/your-repo/rathole-monitor/main/install.sh
chmod +x install.sh
sudo ./install.sh
```
...
1. **دانلود فایل‌ها:**
```bash
git clone https://github.com/your-repo/rathole-monitor.git
cd rathole-monitor
```
...
1. Issue ایجاد کنید در GitHub
2. Pull Request ارسال کنید
3. در بخش Discussions شرکت کنید
...
- از تیم [Rathole](https://github.com/Musixal/Rathole-Tunnel) برای ابزار عالی تانلینگ
- از جامعه توسعه‌دهندگان Python
- از کاربرانی که بازخورد و پیشنهاد می‌دهند

---

**نکته مهم:** این ابزار برای مدیریت بهتر تانل‌های Rathole طراحی شده و نیاز به دانش پایه Linux و شبکه دارد. در صورت عدم اطمینان، ابتدا در محیط تست آزمایش کنید.
