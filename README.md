...
🛠️ Rathole Tunnel Monitor
سیستم مانیتورینگ هوشمند برای تانل‌های Rathole بدون نیاز به کرون‌جاب. این ابزار به‌صورت خودکار وضعیت سرویس‌ها رو بررسی می‌کنه، در صورت نیاز ریستارت می‌کنه و یک وب‌پنل ساده برای مشاهده وضعیت فراهم می‌کنه.
...
پایتون ۳ نصب شده باشد (python3, pip)
